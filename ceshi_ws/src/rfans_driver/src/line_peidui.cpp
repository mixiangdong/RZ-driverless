...
#define loop_times 4
#define utmost_angle 15
#define utmost_angle_2 25
...
spoint left1, left2, right1, right2, middle1, middle2, middle2_, center,
    point[6], point_pair[3][2], temp_point, temp_left, temp_right;
...
int point_state, i1, i2, i3, i4,times_flag;
  ...
  */
  ...
  for (i2 = 0; i2 < 6; i2++) {
    ...
    for (i3 = i2 + 1; i3 < 6; i3++) {
      ...
      if (dis_point_point > 2.5 && dis_point_point < 3.3) {
...
/*
  ...
  */
  if (steering_wheel_angle.data > 40) {
    cout << steering_wheel_angle.data << endl;
    steering_wheel_angle.data = 40;
  } else if (steering_wheel_angle.data < -1 * 40) {
    cout << steering_wheel_angle.data << endl;
    steering_wheel_angle.data = -1 * 40;
  } else {
    steering_wheel_angle.data = steering_wheel_angle.data;
  }
  if(fabs(steering_wheel_angle.data-steering_wheel_angle_save_1)>utmost_angle)
  {
    steering_wheel_angle.data=steering_wheel_angle_save_1+(steering_wheel_angle.data-steering_wheel_angle_save_1)/fabs(steering_wheel_angle.data-steering_wheel_angle_save_1)*utmost_angle;
  }
  double temp=(steering_wheel_angle.data-steering_wheel_angle_save_1)+(steering_wheel_angle_save_1-steering_wheel_angle_save_2);
  if(fabs(temp)>utmost_angle_2)
  {
    steering_wheel_angle.data=steering_wheel_angle_save_2+temp/fabs(temp)*utmost_angle_2;
  }
