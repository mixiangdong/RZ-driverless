...
int main(int argc, char **argv) {
  ...
  ros::Subscriber sub2 = nh.subscribe("Point", 5, callback2);
  /*while (ros::ok()) {
...
void callback2(const rfans_driver::Point::ConstPtr &point_msg) {
  ...
  line_list5.pose.position.x = -1 * lidar_center_dis;
 ...
 line_list4.id = 4;
 line_list4.lifetime = ros::Duration(0.2);
 ...
 line_list7.id = 7;
 line_list7.lifetime = ros::Duration(0.2);
 ...
 line_list8.id = 8;
 line_list8.lifetime = ros::Duration(0.2);
...
*/
    ...
    line_list2.id = 2;
    line_list2.lifetime = ros::Duration(0.2);
    ...
    line_list3.id = 3;
    line_list3.lifetime = ros::Duration(0.2);
  ...
  if (fabs(steering_wheel_angle.data - steering_wheel_angle_save) >= 25 &&
      once_flag == 1) {
    steering_wheel_angle.data = 0.5*(steering_wheel_angle_save+steering_wheel_angle.data);
  } else {
    steering_wheel_angle.data = steering_wheel_angle.data;
  }
  once_flag = 1;
  steering_wheel_angle_save = steering_wheel_angle.data;
