...
class point_zx {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type point_zx
    ...
    bufferOffset = _serializer.float64(obj.y5, buffer, bufferOffset);
    // Serialize message field [x6]
    bufferOffset = _serializer.float64(obj.x6, buffer, bufferOffset);
    // Serialize message field [y6]
    bufferOffset = _serializer.float64(obj.y6, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type point_zx
    let len;
    let data = new point_zx(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new point_zx(null);
    if (msg.x1 !== undefined) {
      resolved.x1 = msg.x1;
    }
    else {
